(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [888],
  {
    ...
    8490: function (t, e, i) {
      ...
      let p = { delta: 0, timestamp: 0, isProcessing: !1 },
        ...
        x = (t) => {
          (f = !1),
            (p.delta = m
              ? 1e3 / 60
              : Math.max(Math.min(t - p.timestamp, 40), 1)),
            (p.timestamp = t),
            (p.isProcessing = !0),
            g.forEach(y),
            (p.isProcessing = !1),
            f && ((m = !1), requestAnimationFrame(x));
        },
        P = () => {
        ...
        b = g.reduce((t, e) => {
          let i = v[e];
          return (
            (t[e] = (t, e = !1, n = !1) => (f || P(), i.schedule(t, e, n))), t
          );
        }, {});
      function w(t) {
        ...
        constructor(t, e = {}) {
          (this.version = "10.12.5"),
            ...
            (this.scheduleVelocityCheck = () =>
              b.postRender(this.velocityCheck)),
              ...
              Object.assign(
                ...
                (function ({ transformTemplate: t }, e, i) {
                  return (0, a.useMemo)(() => {
                    let n = tk();
                    return (
                      tM(n, e, { enableHardwareAcceleration: !i }, t),
      ...
      function tX(t, e, i, n) {
        for (let i in (tH(t, e, void 0, n), e.attrs))
      ...
      function tY(t, e) {
        let { style: i } = t,
          n = {};
        for (let r in i)
          (tr(i[r]) || (e.style && tr(e.style[r])) || tn(r, t)) &&
            (n[r] = i[r]);
        return n;
      }
      function tG(t, e) {
      ...
      let ev = "data-" + tz("framerAppearId"),
        ...
        eS = {};
      for (let t in eA)
        eS[t] = () => (void 0 === eV[t] && (eV[t] = eA[t]()), eV[t]);
      let eE = (t, e, i) =>
      ...
      let eM = eC(0.42, 0, 1, 1),
        ...
        ez = (t) => {
          ...
          return "string" == typeof t
            ? (el(void 0 !== eW[t], `Invalid easing type '${t}'`), eW[t])
            : t;
        },
        eH = (t, e) => (i) =>
          !!(
            (tx(i) && ty.test(i) && i.startsWith(t)) ||
        ...
        eK = {
          ...
          parse: (t) =>
            eG.test(t) ? eG.parse(t) : eZ.test(t) ? eZ.parse(t) : eq.parse(t),
          transform: (t) =>
            tx(t)
              ? t
      ...
      function ie(t) {
        ...
        return (t) => {
          ...
          for (let r = 0; r < s; r++)
            e =
              r < n
                ? e.replace(e9.token, t[r])
                : r < n + i
                ? e.replace(e4.token, eK.transform(t[r]))
                : e.replace(e6.token, tf(t[r]));
          return e;
        };
      }
      ...
      function iV({
        ...
        let B = {
          ...
          get duration() {
            let t =
              null === w.calculatedDuration ? iT(w) : w.calculatedDuration;
            return ex(t);
          },
          get speed() {
            return y;
      ...
      let iS = new Set([
        ...
        iL = (t, e) =>
          ...
          !!(
            "number" == typeof e ||
            Array.isArray(e) ||
            ("string" == typeof e && ir.test(e) && !e.startsWith("url("))
          ),
      ...
      function iQ(t, e, { delay: i = 0, transitionOverride: n, type: r } = {}) {
        ...
        for (let e in a) {
          ...
          n.start(
            iH(e, n, r, t.shouldReduceMotion && ti.has(e) ? { type: !1 } : o)
          );
          let c = n.animation;
      ...
      class i6 {
        constructor(t, e, { transformPagePoint: i } = {}) {
          ...
          a && a(t, nt(r, this.history)),
            (this.removeListeners = t7(
              t6(window, "pointermove", this.handlePointerMove),
              t6(window, "pointerup", this.handlePointerUp),
              t6(window, "pointercancel", this.handlePointerUp)
            ));
        }
        updateHandlers(t) {
          this.handlers = t;
      ...
      function nt({ point: t }, e) {
        return {
          ...
          velocity: (function (t, e) {
            ...
            for (
              ;
              i >= 0 && ((n = t[i]), !(r.timestamp - n.timestamp > ey(0.1)));
        ...
        updateAxis(t, e, i) {
          ...
          this.constraints &&
            ...
            (s = (function (t, { min: e, max: i }, n) {
              return (
                void 0 !== e && t < e
                  ? (t = n ? eJ(e, t, n.min) : Math.max(t, e))
                  : void 0 !== i &&
                    t > i &&
                    (t = n ? eJ(i, t, n.max) : Math.min(t, i)),
                t
              );
        ...
        resolveConstraints() {
          ...
          t && O(t)
            ...
            (this.elastic = (function (t = 0.35) {
              return (
                !1 === t ? (t = 0) : !0 === t && (t = 0.35),
                { x: nc(t, "left", "right"), y: nc(t, "top", "bottom") }
              );
            })(e)),
            n !== this.constraints &&
              i &&
          ...
          nv((t) => {
            ...
            if (e) {
              ...
              n[t] = (function (t, e) {
                ...
                return (
                  r > n
                    ? (i = ih(e.min, e.max - n, t.min))
                    : n > r && (i = ih(t.min, t.max - r, e.min)),
                  tc(0, 1, i)
                );
        ...
        return class {
              ...
              t(e, () => {
                (this.root.updateBlockedByResize = !0),
                  ...
                  Y.hasAnimatedSinceResize &&
                    ((Y.hasAnimatedSinceResize = !1), this.nodes.forEach(rd));
              });
            }
          ...
          didUpdate() {
            ...
            this.isUpdating &&
              ...
              this.potentialNodes.size &&
                (this.potentialNodes.forEach(rb), this.potentialNodes.clear()),
          ...
          applyTransform(t, e = !1) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              !e &&
                ...
                n.scroll &&
                n !== n.root &&
                nD(i, { x: -n.scroll.offset.x, y: -n.scroll.offset.y }),
          ...
          resolveTargetDelta(t = !1) {
            ...
            if (this.layout && (l || u)) {
              ...
              if (this.relativeTarget || this.targetDelta) {
                if (
                  ((this.target ||
                    ((this.target = ng()), (this.targetWithTransforms = ng())),
                  this.relativeTarget &&
                    this.relativeTargetOrigin &&
                    this.relativeParent &&
                  ...
                  for (let a = 0; a < o; a++) {
                    ...
                    (!o || !o.style || "contents" !== o.style.display) &&
                      (n &&
                        ...
                        r.scroll &&
                        r !== r.root &&
                        nD(t, { x: -r.scroll.offset.x, y: -r.scroll.offset.y }),
                  ...
                  h &&
                    ...
                    (function (t, e, i, n, r, s) {
                      ...
                      for (let r = 0; r < nz; r++) {
                        ...
                        l
                          ? ((t[s] = Math.max(eJ(nH(o), nH(a), n), 0)),
                            (tw.test(a) || tw.test(o)) && (t[s] += "%"))
                          : (t[s] = a);
                      }
                      (e.rotate || i.rotate) &&
                        (t.rotate = eJ(e.rotate || 0, i.rotate || 0, n));
          ...
          getProjectionStyles(t = {}) {
            ...
            return (
              this.options.layoutId &&
                (n.pointerEvents =
                  s === this ? tQ(t.pointerEvents) || "" : "none"),
              n
            );
          }
          clearSnapshot() {
      ...
      function ro(t) {
        ...
        if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
          ...
          let a = nm();
          s
            ? ns(a, t.applyTransform(n, !0), i.measuredBox)
            : ns(a, e, i.layoutBox);
          let l = !n3(o),
            u = !1;
          if (!t.resumeFrom) {
      ...
      function rT(t, e, i) {
        return (
          "position" === t ||
          ("preserve-aspect" === t && !nn(n4(e), n4(i), 0.2))
        );
      }
      let rA = rr({
      ...
      let rM = new Set([
        ...
        rU = (t, e, i, n) => {
          ...
          return (
            ...
            (r = e),
            (s = n),
            rD(r) ? rN(t, r, i, s) : { target: r, transitionEnd: s }
          );
        },
        r$ = { current: null },
        rW = { current: !1 },
      ...
      class rG {
          ...
          (this.prevMotionValues = (function (t, e, i) {
            ...
            for (let r in e) {
              ...
              if (tr(s)) t.addValue(r, s), i_(n) && n.add(r);
                ...
                t.addValue(r, C(s, { owner: t })), i_(n) && n.remove(r);
              else if (o !== s) {
                if (t.hasValue(r)) {
                  let e = t.getValue(r);
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === i &&
              void 0 !== e &&
              ((i = C(e, { owner: this })), this.addValue(t, i)),
            i
          );
        }
        readValue(t) {
          ...
          let { initial: i } = this.props,
            n =
              "string" == typeof i || "object" == typeof i
                ? null === (e = tq(this.props, i)) || void 0 === e
                  ? void 0
                  : e[t]
                : void 0;
          if (i && void 0 !== n) return n;
          let r = this.getBaseTargetFromProps(this.props, t);
          return void 0 === r || tr(r)
                    ...
                    null === u &&
                      (u =
                        null !==
                          ...
                          : e[o]),
                    null != u &&
                      ("string" == typeof u && (iX(u) || iY(u))
                        ? (u = parseFloat(u))
                        : !iJ(u) && ir.test(l) && (u = iU(o, l)),
        ...
        rQ = {
              ...
              startObserver() {
                ...
                return (function (t, e, i) {
                  let n = (function ({ root: t, ...e }) {
                    ...
                    return (
                      n[r] ||
                        (n[r] = new IntersectionObserver(ep, {
                          root: t,
                          ...e,
                        })),
                      n[r]
                ...
                super(...arguments),
                  ...
                  (this.startAccessiblePress = () => {
                    let t = (t) => {
                      ...
                      i = () => {
                        this.isPressing &&
                          eu("cancel", (t, e) => this.cancelPress(t, e));
                      },
          ...
          pan: {
            Feature: class extends es {
              ...
              mount() {
                this.removePointerDownListener = t6(
                  this.node.current,
                  "pointerdown",
            ...
            return (function ({
              ...
              let s = (0, a.forwardRef)(function (s, o) {
                ...
                if (!d && j) {
                  ...
                  p.visualElement &&
                    (h = p.visualElement.loadFeatures(c, n, t, m, i));
                }
            ...
            return {
              ...
              useRender: (function (t = !1) {
                let e = (e, i, n, r, { latestValues: s }, o) => {
                  ...
                  return (
                    n && (c["data-projection-id"] = n),
                    (0, a.createElement)(e, { ...c, children: p })
                  );
                };
                return e;
              })(e),
